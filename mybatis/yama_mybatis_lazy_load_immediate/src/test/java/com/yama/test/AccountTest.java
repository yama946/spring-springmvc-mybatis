...
public class AccountTest {
    ...
    public void testfindAllAccountUser(){
        List<AccountUser> accounts = mapper.findAllAccountUser();
        for (AccountUser a:accounts){
            System.out.println(a);
        }
    }
    @Test
    public void testfindAllAccountUser1(){
        List<Account> accounts = mapper.findAllAccountUser1();
        for (Account a:accounts){
            System.out.println(a);
    ...
    //延迟加载测试
    @Test
    public void testfindLazyLoad(){
        List<Account> accounts = mapper.findLazyload();
        for (Account a:accounts){
            System.out.println(a);
            //当需要用户时，才进行加载
//            System.out.println(a.getUser());
